...
dv/dt = (I_app - I_Na - I_K - I_T - I_h - I_L + IPY + IRE)/Cm : volt
...
dv/dt = (I_app - I_Na - I_K - I_T - I_L + IPY + ITC + IRE)/Cm : volt
IPY: amp
ITC: amp
IRE: amp
''')
...
PY = NeuronGroup(1, model_PY,threshold='not_refractory and (v > 0*mV)',
                    refractory='v > 0*mV')
LTS =NeuronGroup(1, model_LTS,threshold='not_refractory and (v > 0*mV)',
                    refractory='v > 0*mV')
FS = NeuronGroup(1, model_PY,threshold='not_refractory and (v > 0*mV)',
                    refractory='v > 0*mV')
TC = NeuronGroup(1, model_TC,threshold='not_refractory and (v > 0*mV)',
                    refractory='v > 0*mV')
RE = NeuronGroup(1, model_RE,threshold='not_refractory and (v > -40.*mV)',
                    refractory='v > -40.*mV')
PY.v = E_L
FS.v = E_L
LTS.v = E_L
